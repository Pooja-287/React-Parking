...
const ExtendPass = () => {
  ...
  useEffect(() => {
    axios.get(`https://q8dcnx0t-5000.inc1.devtunnels.ms/api/public/${id}`)
  ...
  const handlePayment = async () => {
    ...
    try {
      const res = await axios.post('https://q8dcnx0t-5000.inc1.devtunnels.ms/api/payment/create-order', {
      ...
      const options = {
        ...
        handler: async function (response) {
          ...
          await axios.put(`https://q8dcnx0t-5000.inc1.devtunnels.ms/api/extendPass/${id}`, {
